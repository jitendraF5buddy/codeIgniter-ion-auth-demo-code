          ...
          <section class="login_content">
            <form method="post" action="<?php echo base_url('auth/login'); ?>">
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> Demo Login</h1>
                  <p> © Copyright  Demo. All Rights Reserved. Privacy and Terms</p>
                </div>
              </div>
            </form>
          </section>
          ...
          <section class="login_content">
            <form>
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> Demo</h1>
                  <p>©2016 All Rights Reserved. Demo is a Bootstrap 3 template. Privacy and Terms</p>
                </div>
              </div>
            </form>
          </section>
