...
$( document ).ready(function() {
    ...
    if ($('body').hasClass('has-charts')){
        var a1 = $('#pending_percent').val();
        var a2 = $('#uploaded_percent').val();
        var a3 = $('#failed_percent').val();
debugger;
        var pieData = [
            {	value: a3,	color: "#c0392b", highlight: "#c0392b", label: "Red"			},
            {	value: a2,	color: "#27ae60", highlight: "#27ae60",	label: "Green"			},
            {	value: a1,	color: "#2980b9", highlight: "#34495e",	label: "Dark Blue"		}
        ];
        var barChartData = {
